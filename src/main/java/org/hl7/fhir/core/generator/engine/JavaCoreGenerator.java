...
import org.hl7.fhir.core.generator.codegen.*;
...
//      System.out.println("3: project directory to generate code into - e.g. C:\\work\\org.hl7.fhir\\org.hl7.fhir.core\\org.hl7.fhir.r5.new");
      //} else {
//      String version = args[0];
      String version = "4.5.0";//"current";
//      String src = args[1];
      String src = "/home/mark/Documents/Projects/FHIR/prometheus/configuration";
//      String dest = args[2];
      String dest = "/home/mark/Documents/Projects/FHIR/prometheus/generated";
      new JavaCoreGenerator().generate(version, src, dest);
//    }
  }
  ...
  private void generate(String version, String src, String dest) throws Exception {
    ...
    JavaConstantsGenerator cgen = new JavaConstantsGenerator(new FileOutputStream(Utilities.path(dest, "src", "org", "hl7", "fhir", "r5", "model", "Constants.kt")), master, config, date, npm.version());
    cgen.generate();
    cgen.close();

    System.out.println(" .. Enumerations");
    JavaEnumerationsGenerator egen = new JavaEnumerationsGenerator(new FileOutputStream(Utilities.path(dest, "src", "org", "hl7", "fhir", "r5", "model", "Enumerations.kt")), master, config, date, npm.version());
    egen.generate();
    egen.close();
